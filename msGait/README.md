...
- `gps_min_points`, `gps_min_distance_m`, `gps_min_speed_m_s`, and
  `gps_max_speed_m_s` define the GPS plausibility rules used to set `gps_validated`.
...
Full Sphinx-generated docs live in [`docs/msGait.rst`](../docs/msGait.rst).
